        ...
        <div class="pusher">
            <div class="main-content">
                <div class="container-fluid">
                    <br><br>
                    <div><i class="fas fa-home"></i><i style="margin : 5px;" class="fas fa-angle-right"></i><a href="../dashboard/view">Dashboard</a><i style="margin : 5px;"  class="fas fa-angle-right"></i><a href="../setting/list">Settings List</a><i style="margin : 5px;"  class="fas fa-angle-right"></i>Add a Setting</div>
                            <br>
