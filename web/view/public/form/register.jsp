                    ...
                    <div class="signup-content">
                        <div class="signup-form">
                            ...
                            <form oninput='re_pass.setCustomValidity(re_pass.value !=pass.value ? "Passwords do not match." : "")' novalidate  method="POST" action="register" class="register-form needs-validation" id="register-form">
                                ...
                                <div class="form-group">
                                    Male : <input style="width: 10%; display: inline-block" checked="true" type="radio" name="gender" value="true">
                                    Female : <input style="width: 10%; display: inline-block" type="radio" name="gender" value="false">

                                </div>
                                <div class="form-group">
                                    <label  for="email"><i class="zmdi zmdi-email"></i></label>
                                    <input pattern="[^ @]*@[^ @]*" required="true" type="email" name="email" id="email" placeholder="Your Email"/>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input pattern="[0-9]{10}" required="true" type="phone" name="phone" id="phone" placeholder="Your Phone"/>
                                    <div class="invalid-feedback">
                                ...
                                <div class="form-group">
                                    ...
                                    <input pattern="[A-Za-z]{6+}" required="true" type="address" name="address" id="address" placeholder="Your Address"/>
                                    <div class="invalid-feedback">
                                        Please input a valid address at least 6 characters
                                    </div>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    <input required="true" type="checkbox" name="agree-term" id="agree-term" class="agree-term" />
                                    <label for="agree-term" class="label-agree-term"><span><span></span></span>I agree all statements in  Terms of service</label>
                                    <div class="invalid-feedback">
                                        Please agree with our terms before register
                                    </div>
                                </div>
                                <div class="form-group form-button">
                                    <input type="submit" name="signup" id="signup" class="form-submit" value="Register"/>
                                    <input type="button"  class="form-submit" value="Sign in" />
                                </div>
                            </form>
                        </div>
