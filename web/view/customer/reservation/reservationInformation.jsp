...
<html lang="en">
    ...
    <body id="top" data-spy="scroll" data-target=".navbar-collapse" data-offset="50">
        ...
        <div class="container" style=" margin-top: 25px;margin-bottom: 25px;min-height: 700px; height: auto;">
            ...
            <div style=" font-size: 50px; margin-top:25px; " class="ui grid">

                <div style="margin: 0 auto" class="twelve wide column">
                    <form style="font-size:14px; " id="form" enctype="multipart/form-data" action="feedback/add" method="POST" class="ui form">
             ...
             <div style="margin-top:25px;" class="ui grid">
                ...
                <div style="margin: 0 auto" class="twelve wide column">
                    <form style="font-size:14px; " id="form" enctype="multipart/form-data" action="feedback/add" method="POST" class="ui form">
                        <h2 class="ui dividing header">Reservation Information</h2>
                        <div class="two fields">
