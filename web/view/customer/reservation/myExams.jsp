        ...
        <div class="container" style="min-height: 700px; height: auto; max-width: 80%">
            <c:if test="${requestScope.medexam.size()>0}">
                <table class="table" id="myExams">
                    ...
                    <tbody>
                        <c:forEach var="list" items="${requestScope.medexam}">
                            <tr>
                                ...
                                <td class="col-md-1">${list.getReservationService().reservation.getCheckupTime()}</td>
                                <td class="col-md-1">
            ...
            <c:if test="${requestScope.medexam.size()==0}">
                <h2 style="font-size: 30px">You do not have any Prescriptions</h2>
                <button class="btn btn-primary" onclick="window.location.href = '../reservation/my'">Go to Reservations</button>
