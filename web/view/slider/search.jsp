            ...
            <nav class="navbar navbar-light bg-light">
                <form id="myForm" method="GET" action="search" class="form-inline">
                    ...
                    <select  onchange="submit()" style="margin: 0 200px;" name="status">
                        ...
                        <option <c:if test="${requestScope.status == 'none'}">selected="true"</c:if> value="none">All</option>
                        <option <c:if test="${requestScope.status == 'true'}">selected="true"</c:if> value="true">Active</option>
                        <option <c:if test="${requestScope.status == 'false'}">selected="true"</c:if> value="false">Inactive</option>
                    </select>
                    ...
                    success:
                            function (data) {
                                    ...
                                    if(b["status"] == false){
                                            ...
                                            param.innerHTML = '<i  class="fas fa-eye-slash" aria-hidden="true"></i>';
                                        
                                    }
                                    if(b["status"]==true){
                                        
                                        
                                            param.innerHTML = '<i  class="fas fa-eye   " aria-hidden="true"></i>';
                                    }
