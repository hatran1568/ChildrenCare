                ...
                <table style="width: 100%">
                    <tr>
                        ...
                        <td>
                            ...
                            <img id="output" src="../../${requestScope.slider.imageLink}" > 
                        </td>
                    </tr>
                    <tr>
                        <td>Title</td>
                        <td><input value="${requestScope.slider.title}" style="width: 100%" type="text" name="title"></td>
                    </tr>
                    <tr>
                        <td>Backlink</td>
                        <td><input value="${requestScope.slider.backlink}" style="width: 100%" type="text" name="backlink"></td>
                    </tr>
                    <tr>
                        <td>Status</td>
                    ...
                    <tr>
                        <td>Notes</td>
                        <td><input value="${requestScope.slider.notes}" style="width: 100%" type = "text" name="note"></td>
                    </tr>
                </table>
