<%-- 
    Document   : add
    Created on : May 24, 2021, 2:28:12 AM
    Author     : HP
--%>
                    ...
                    <div class="col-md-12">
                        <div class="full">
                            <div class="heading_main text_align_center">
                                <h2><span class="theme_color"></span>Add New Post</h2>    
                            </div>
                        </div>
                    </div>
                </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-lg-6 col-sm-12 offset-lg-3">
                        <div class="full">
                            <form class="contact_form_inner" action="add" method="POST">
                                <fieldset>
                                    <div class="field">
                                        <span style="color: white; background-color: black;">Category: </span><select name="post_category">
                                            <c:forEach items="${requestScope.post_categories}" var="pc">
                                                <option value="${pc.id}">
                                                    ${pc.name}
                                                </option>
                                            </c:forEach>
                                    ...
                                    <div class="field">
                                        <input type="date" required="" name="updated_date" placeholder="Updated Date"/>
                                    </div>
                                    <div class="field">
                                        <textarea  name="content" required=""  placeholder="Content"></textarea>
                                    </div>
                                    <div class="field">
                                        <input required="" type="text" name="thumbnail_link" placeholder="Thumbnail Link"/>
                                    </div>
