...
-- Records of feedback
-- ----------------------------
INSERT INTO `feedback` VALUES (1, 'Yan', 1, 'Admin@a', '032', 3, 'none', 1, '#');
INSERT INTO `feedback` VALUES (2, 'Yan', 1, 'Admin@a', '032', 4, 'none', 2, '#');
INSERT INTO `feedback` VALUES (3, 'Yan', 1, 'Admin@a', '032', 3, 'none', 3, '#');
INSERT INTO `feedback` VALUES (4, 'Yan', 1, 'Admin@a', '032', 2, 'none', 1, '#');
INSERT INTO `feedback` VALUES (5, 'Yan', 1, 'Admin@a', '032', 3, 'none', 2, '#');
INSERT INTO `feedback` VALUES (6, 'Yan', 1, 'Admin@a', '032', 5, 'none', 1, '#');
...
INSERT INTO `post` VALUES (33, NULL, 'Talk of ‘gain-of-function’ research, a muddy category at best, brings up deep questions about how scientists should study viruses and other pathogens.', NULL, 1, 'assets/images/service/s2.jpg', 16, 6, 1, 'Fight Over Covid’s Origins Renews Debate on Risks of Lab Work');
INSERT INTO `post` VALUES (34, NULL, 'Organisers are to decide as soon as Monday whether to allow domestic spectators into the stadiums for the Games, which were delayed by a year due to the pandemic and now set to start in about a month. Foreign spectators have already been banned.', NULL, 0, 'assets/images/service/128283710.jpg', 28, 7, 1, 'Olympics venue medical officers want no spectators amid COVID-19 fears');
INSERT INTO `post` VALUES (35, NULL, 'With summer in full swing and excessive heat waves rolling through parts of the country, taking a dip in water can be a refreshing way to cool off.', NULL, 0, 'assets/images/service/dd7184.png', 29, 8, 1, 'What to do to stay safe around water this summer at the pool or beach');
...
-- Records of slider
-- ----------------------------
INSERT INTO `slider` VALUES (1, 'Chao1', 'assets/images/service/s1.jpg', '#', 1, 'none');
...
INSERT INTO `slider` VALUES (9, 'Hue', 'assets/images/service/dd7184.png', '#', 1, 'none');
INSERT INTO `slider` VALUES (10, 'navi', 'assets/images/slider/slider.png', '#', 0, 'none');
INSERT INTO `slider` VALUES (11, 'Ha', 'assets/images/service/s3.png', '#', 1, 'none');
INSERT INTO `slider` VALUES (12, 'Chi', 'assets/images/slider/slider.png', '#', 1, 'none');
INSERT INTO `slider` VALUES (13, 'ilgnd', 'assets/images/service/Medical-logo-vector-lage.jpg', '#', 1, 'none');
...
INSERT INTO `slider` VALUES (19, 'navi', 'assets/images/UML.png', '#', 1, 'none');
