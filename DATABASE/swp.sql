...
CREATE TABLE `feedback`  (
  ...
  INDEX `fk_status_setting`(`status_id`) USING BTREE,
  CONSTRAINT `feedback_ibfk_1` FOREIGN KEY (`service_id`) REFERENCES `service` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT,
  CONSTRAINT `fk_status_setting` FOREIGN KEY (`status_id`) REFERENCES `setting` (`id`) ON DELETE RESTRICT ON UPDATE RESTRICT
...
INSERT INTO `feedback` VALUES (4, 'Yan', 1, 'Admin@a', '032', 2, 'none', 1, 'assets/images/54434668_2225997277642766_1772641468163293184_o.jpg', 29);
INSERT INTO `feedback` VALUES (5, 'Yan', 1, 'Admin@a', '032', 3, 'none', 2, '#', 29);
INSERT INTO `feedback` VALUES (6, 'Yan', 1, 'Admin@a', '032', 5, 'none', 1, '#', 29);
INSERT INTO `feedback` VALUES (7, 'Yan', 1, 'Admin@a', '032', 3, 'none', 1, '#', 29);
INSERT INTO `feedback` VALUES (8, 'Tá»ng TrÆ°á»ng Giang', 0, 'Fusce@loremipsum.ca', '0977659677', 5, 'none', NULL, 'assets/images/61443344_1190947827744901_7639894762496983040_o (2).jpg', 28);
INSERT INTO `feedback` VALUES (9, 'Tá»ng TrÆ°á»ng Giang', 1, 'Fusce@loremipsum.ca', '0977659677', 5, 'none', 1, 'assets/images/54434668_2225997277642766_1772641468163293184_o.jpg', 28);
INSERT INTO `feedback` VALUES (10, 'DÆ°Æ¡ng', 0, 'Fusce@loremipsum.ca', '0977659677', 4, 'lorem isum', NULL, 'assets/images/54434668_2225997277642766_1772641468163293184_o (2).jpg', 29);
...
INSERT INTO `medical_examination` VALUES (1, 3, 2, 'Cyanide: 3 times a day; Beta Blockers: 1 after lunch');
...
-- ----------------------------
INSERT INTO `reservation` VALUES (1, 5, '2021-06-27 11:15:11', 20, 7, 2, '2021-06-27 11:15:48');
INSERT INTO `reservation` VALUES (2, 5, '2021-06-27 11:15:11', 21, 7, 2, '2021-06-27 11:15:48');
