...
INSERT INTO `post` VALUES (1,'Things aren\'t going well at all with mom today. She is just a limp noodle and wants to sleep all the time. I sure hope that things get better soon. \nI guess we could discuss the implications of the phrase \"meant to be.\" That is if we wanted to drown ourselves in a sea of backwardly referential semantics and other mumbo-jumbo. Maybe such a discussion would result in the determination that \"meant to be\" is exactly as meaningless a phrase as it seems to be, and that none of us is actually meant to be doing anything at all. \nBut that\'s my existential underpants underpinnings showing. It\'s the way the cookie crumbles. And now I want a cookie. It seemed like it should have been so simple. There was nothing inherently difficult with getting the project done. It was simple and straightforward enough that even a child should have been able to complete it on time, but that wasn\'t the case. The deadline had arrived and the project remained unfinished.','I\'m meant to be writing at this moment. What I mean is, I\'m meant to be writing something else at this moment.','2001-01-01 00:00:00',1,'assets/images/slider/slider.png',5,6,NULL,'Lorem Ipsum'),(2,'Content','This is important to remember. ','2001-01-01 00:00:00',1,'assets/images/slider/slider.png',5,5,NULL,'What have you noticed today?'),(3,'Content','What looked like stones in the pasture were actually rock candy','2001-01-01 00:00:00',1,'assets/images/slider/slider.png',2,7,NULL,'I am grateful for the distraction.'),(31,'Content','Description','2001-01-01 00:00:00',1,'assets/images/slider/slider.png',2,7,NULL,'Sketch Demo');
...
INSERT INTO `receiver` VALUES (1,2,'Bo Yates',0,'0559706307','3852 Ridiculus Rd.','Fusce@loremipsum.ca'),(2,2,'John Doe',1,'012345678','6661 Neque Avenue','egestas.drerit@mauriserat.net'),(7,36,'DÆ°Æ¡ng',1,'0974484610','30','sad'),(8,-1,'Tá»ng TrÆ°á»ng Giang',1,'0977659677','19','admin@a'),(9,-1,'DÆ°Æ¡ng',1,'0977659677','30','sad@a'),(10,-1,'turuek',0,'1425678','121323123','a@a'),(11,2,'hedsafs',1,'0321234567','abcxyz','ds@fdzaws');
...
INSERT INTO `reservation` VALUES (2,2,'2021-06-22 22:32:39','Cancel',26,1),(36,2,'2021-06-20 00:00:00','Submited',7,1),(37,2,'2021-06-20 00:00:00','Cancel',7,1),(38,2,'2021-06-20 00:00:00','Submited',7,1),(39,2,'2021-06-20 00:00:00','Submited',7,1),(40,2,'2021-06-20 00:00:00','Submited',7,1),(41,2,'2021-06-20 00:00:00','Submited',7,1),(42,2,'2021-06-20 00:00:00','Submited',13,1),(43,2,'2021-06-20 00:00:00','Submited',13,1);
...
CREATE TABLE `reservation_service` (
  ...
  KEY `fk_reservation` (`reservation_id`) USING BTREE,
...
INSERT INTO `reservation_service` VALUES (36,1,1,2,'2021-06-20',90000.00,3),(36,2,1,1,'2021-06-20',100000.00,4),(38,1,1,2,'2021-06-20',90000.00,5),(38,2,1,1,'2021-06-20',100000.00,6),(40,1,1,11,'2021-06-20',90000.00,7),(40,2,1,1,'2021-06-20',100000.00,8),(42,1,1,2,'2021-06-20',90000.00,9),(42,2,1,1,'2021-06-20',100000.00,10);
...
INSERT INTO `slider` VALUES (1,'Chao','assets/images/slider/slider.png','#',1,'none'),(2,'Chao','assets/images/slider/slider.png','#',1,'none'),(4,'Chao','assets/images/tiktok-10x-chau-anh.jpg','#',1,'none'),(5,'Isum','assets/images/slider/slider.png','#',0,'none'),(6,'navi','assets/images/slider/slider.png','#',1,'none'),(7,'CHao','assets/images/slider/slider.png','#',0,'none'),(8,'navi','assets/images/slider/slider.png','#',0,'none'),(9,'Hue','assets/images/slider/slider.png','#',1,'none'),(10,'navi','assets/images/slider/slider.png','#',0,'none'),(11,'Ha','assets/images/slider/slider.png','#',1,'none'),(12,'Chi','assets/images/slider/slider.png','#',1,'none'),(13,'ilgnd','assets/images/slider/slider.png','#',1,'none'),(14,'navi','assets/images/slider/slider.png','#',0,'none'),(15,'navi','assets/images/slider/slider.png','#',0,'none'),(18,'navi','assets/images/UML.png','#',0,'none');
...
INSERT INTO `user_history` VALUES (10,'Integer.aliquam.adipi@vel.com','Linda Solis',1,'0321248916','help',0,2,'2021-06-20 21:39:31',4),(10,'Integer.aliquam.adipi@vel.com','Linda Solis',0,'0321248916','help',0,2,'2021-06-21 09:48:11',4),(10,'Integer.aliquam.adipi@vel.com','Linda Solis',1,'0321248916','help',0,2,'2021-06-21 09:51:10',4),(10,'Integer.aliquam.adipi@vel.com','Linda Solis',0,'0321248916','help',0,2,'2021-06-21 10:22:29',4),(10,'Integer.aliquam.adipi@vel.com','Linda Solis',0,'0123456789','help',0,2,'2021-06-21 10:25:06',4);
...
-- Dump completed on 2021-06-21 18:20:29
